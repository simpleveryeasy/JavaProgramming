...
public class ReplaceExercise {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(word.replace("hub","lab")); // actually an object is created but
        // not assigned to a reference (so we have an unreferenced object) Garbage collector cleans that object
