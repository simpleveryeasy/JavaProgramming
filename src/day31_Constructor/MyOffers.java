...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("VA", "Amazon Inc", "SDET", 110000, true,
                true, true, true);
        ...
        offer3.setInfo("FL", "Apple Inc", "QE", 125000, true,
                true, true, false);
        ...
        offer5.setInfo("WA", "Bank Of America", "BA", 130000, true,
                false, false, true);
        ...
        localOffers.removeIf(p -> !(p.location.equals("VA") || p.location.equals("CA"))); //removes the offer that not VA or CA
        System.out.println(localOffers.size()); //2

        for (Offer localOffer : localOffers) {
            System.out.println(localOffer.companyName + " : " + localOffer.salary); //Amazon Inc : 110000.0 Sony : 120000.0
        }
