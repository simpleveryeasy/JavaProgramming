...
public class AccessModifiersTest2 {
    ...
    //  System.out.println(AccessModifiers.privateData); // private is not visible outside the class and package


        AccessModifiers.method1();
    //  AccessModifiers.method2(); // default is not visible outside the package
    //  AccessModifiers.method3(); // private is not visible outside the class and package
    }
}
