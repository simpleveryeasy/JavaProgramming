...
public class PolymorphismPractice2 {
    ...
    public static void main(String[] args) {
        ...
        for (Tester eachTester : testers) {
            if (eachTester.getSalary() > maxSalaryTester.getSalary()){
                maxSalaryTester = eachTester;
            }
        }
        System.out.println(maxSalaryTester.getSalary());
        ...
        for (Developer eachDeveloper : developers) {
            if (eachDeveloper.getSalary() > maxSalaryDeveloper.getSalary()){
                maxSalaryDeveloper = eachDeveloper;
            }
        }
        System.out.println(maxSalaryDeveloper.getSalary());
